...
const CampaignCard = ({ show, onClose, onCampaignCreated }) => {
  ...
  const [inputMode, setInputMode] = useState("manual"); // default mode manual
  ...
  const handlePreview = async () => {
    ...
    try {
      // Assume your backend has an endpoint /api/audience-size that accepts the query
      ...
      toast.error("Error fetching audience size");
    } finally {
